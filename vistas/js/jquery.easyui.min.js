...
},beforePageText:"Pag.",afterPageText:"de {pages}",displayMsg:"Mostrando {from} de {to} de {total} registros",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"Este campo es obligatorio.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,events:{focus:_477,blur:_47b,mouseenter:_47f,mouseleave:_482,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
...
},message:"Ingrese un correo valido."},url:{validator:function(_4a2){
